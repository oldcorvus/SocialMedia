...
class Article(models.Model):
    ...
    created = models.DateTimeField(auto_now_add=True, null=True, blank=True, verbose_name="تاريخ ساخت")
    updated = models.DateTimeField(auto_now=True, verbose_name="تاريخ تغيير")
    publish = models.DateTimeField(default=timezone.now, verbose_name="تاريخ انتشار")
    category = models.ManyToManyField('Category', verbose_name="دسته بندي", related_name="articles")
    author = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name="نويسنده",related_name="articles")
